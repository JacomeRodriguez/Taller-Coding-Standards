...
public class Calculator {
	...
	/**
	 * Este metodo realiza una operación aritmetica y retorna el valor.
	 * @param first double  num1
	 * @param second double num2
	 * @param operator char operador-aritmentico
	 * @return result double resultado
	 */
